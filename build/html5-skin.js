...
},{"../../constants/constants":36,"../closeButton":4,"../utils":34,"./onOffSwitch":13,"react":212}],9:[function(require,module,exports){
var React = require('react'),
    Utils = require('../utils'),
    CONSTANTS = require('../../constants/constants'),
    SelectionContainer = require('./selectionContainer'),
...
OO.plugin("Html5Skin", function (OO, _, $, W) {
  ...
  if (OO.publicApi && OO.publicApi.VERSION) {
    ...
    OO.publicApi.VERSION.skin = {"releaseVersion": "4.8.5", "rev": "04fc03fbe5031cdfd59ea215d5565cb0446b2209"};
  }
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: "oo-state-screen oo-pause-screen"}, 
        ...
        React.createElement("form", {className: "oo-action-icon-pause", onSubmit: this.handleCommentSubmit}, 
          React.createElement("label", {htmlFor: "comment"}, "Comment:"), 
          React.createElement("input", {type: "text", id: "comment", value: this.state.commentText, onChange: this.handleCommentChanged})
        ), 
